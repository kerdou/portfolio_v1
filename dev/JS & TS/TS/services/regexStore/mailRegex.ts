export function mailRegex(mailValue: string): boolean {
     ...
     *
     * Par conséquent, la regex a du être modifiée en ajoutant ‘’ parmis les caractères spéciaux
     */
    ...
    return mailRegex.test(mailValue.trim());
}
