...
export default function stackManagement() {
    ...
    const stackObj: stackObjIntf = {
        html: {
            element: document.getElementById('html') as HTMLSpanElement,
            title: 'HTML',
        ...
        css: {
            element: document.getElementById('css') as HTMLSpanElement,
            title: 'CSS',
        ...
        sass: {
            element: document.getElementById('sass') as HTMLSpanElement,
            title: 'SaSS',
        ...
        bootstrap: {
            element: document.getElementById('bootstrap') as HTMLSpanElement,
            title: 'Bootstrap',
        ...
        javascript: {
            element: document.getElementById('javascript') as HTMLSpanElement,
            title: 'JavaScript',
        ...
        typescript: {
            element: document.getElementById('typescript') as HTMLSpanElement,
            title: 'TypeScript',
        ...
        lodash: {
            element: document.getElementById('lodash') as HTMLSpanElement,
            title: 'Lodash',
        ...
        php: {
            element: document.getElementById('php') as HTMLSpanElement,
            title: 'PHP',
        ...
        mysql: {
            element: document.getElementById('mysql') as HTMLSpanElement,
            title: 'MySQL',
        ...
        wordpress: {
            element: document.getElementById('wordpress') as HTMLSpanElement,
            title: 'WordPress',
        ...
        angular: {
            element: document.getElementById('angular') as HTMLSpanElement,
            title: 'Angular',
        ...
        windows: {
            element: document.getElementById('windows') as HTMLSpanElement,
            title: 'Windows',
        ...
        linux: {
            element: document.getElementById('linux') as HTMLSpanElement,
            title: 'Linux / Ubuntu',
        ...
        vscode: {
            element: document.getElementById('vscode') as HTMLSpanElement,
            title: 'VS Code',
        ...
        apache: {
            element: document.getElementById('apache') as HTMLSpanElement,
            title: 'Apache',
        ...
        phpmyadmin: {
            element: document.getElementById('phpmyadmin') as HTMLSpanElement,
            title: 'phpMyAdmin',
        ...
        asana: {
            element: document.getElementById('asana') as HTMLSpanElement,
            title: 'Asana',
        ...
        jmerise: {
            element: document.getElementById('jmerise') as HTMLSpanElement,
            title: 'JMerise',
        ...
        plantuml: {
            element: document.getElementById('plantuml') as HTMLSpanElement,
            title: 'PlantUML',
        ...
        github: {
            element: document.getElementById('github') as HTMLSpanElement,
            title: 'GitHub',
        ...
        npm: {
            element: document.getElementById('npm') as HTMLSpanElement,
            title: 'npm',
        ...
        composer: {
            element: document.getElementById('composer') as HTMLSpanElement,
            title: 'Composer',
        ...
        webpack: {
            element: document.getElementById('webpack') as HTMLSpanElement,
            title: 'Webpack',
        ...
        gulp: {
            element: document.getElementById('gulp') as HTMLSpanElement,
            title: 'Gulp',
        ...
        prettier: {
            element: document.getElementById('prettier') as HTMLSpanElement,
            title: 'Prettier',
        ...
        eslint: {
            element: document.getElementById('eslint') as HTMLSpanElement,
            title: 'ESLint',
        ...
        phpcs: {
            element: document.getElementById('phpcs') as HTMLSpanElement,
    ...
    const stackModalArrow = document.getElementById('stackModalArrow') as HTMLDivElement;

    const stackModalBox = document.getElementById('stackModal') as HTMLDivElement;
    const stackModalContent = document.getElementById('stackModalContent') as HTMLDivElement;
    const stackModalTitle = document.getElementById('stackModalTitle') as HTMLHeadingElement;
    const stackModalDescr = document.getElementById('stackModalDescr') as HTMLParagraphElement;
    const stackModalLink = document.getElementById('stackModalLink') as HTMLAnchorElement;
    ...
    function stackModalAppearing(evt: Event) {
        ...
        const parentStackPod = stackIconElem.parentElement!.parentElement as HTMLDivElement;
        const techID = stackIconElem.id;
    ...
    function iconClickDebouce(techID: string) {
        (document.getElementById(techID) as HTMLSpanElement).removeEventListener('click', stackModalAppearing);
        window.setTimeout(() => (document.getElementById(techID) as HTMLSpanElement).addEventListener('click', stackModalAppearing), 250);
    }
